...
export class StreamService {
  ...
  private loadStreams() : StreamModel[] {
    ...
    //streamsFound.push({id: 4, url: "https://videos-3.earthcam.com/fecnetwork/4282.flv/chunklist_w87819152.m3u8", videoType: "application/x-mpegURL", name: "New Orleans"})
    //streamsFound.push({id: 5, url: "https://videos-3.earthcam.com/fecnetwork/15559.flv/chunklist_w588120173.m3u8", videoType: "application/x-mpegURL", name: "Crossroads"})
